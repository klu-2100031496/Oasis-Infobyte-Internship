...
class BankAccount {
    ...
    void withdraw(int amount) {
        if (this.balance > amount) {
            ...
            prevTransaction = -amount;
             System.out.println("\n");
             System.out.println("The amount of money withdrawn from your account is  Rs. "+ amount);
    ...
    public void transfer(double amount, BankAccount acc) {
        if (this.balance < amount) {
            ...
            this.balance -= amount;
            acc.balance += amount;
            System.out.println("Account of " + this.customerName + " becomes Rs." + this.balance);
            System.out.println("Account of " + acc.customerName + " becomes Rs." + acc.balance);
            System.out.println("\n");
        }
    }
            ...
            do {
                ...
                switch (option) {
                    ...
                    case '2':
                        ...
                        deposit(amount);
                        System.out.println("\n");
                        System.out.println("The amount of money deposited in your account is  Rs. "+ amount);
                        break;
...
public class ATMInterface {
    public static void main(String[] args) {
        BankAccount ba = new BankAccount("Nikhil Sai", "1478");
        ba.checkId();
    }
